...
<div className="Novelpage">
    <div className="body-header">
        <div className="image-novel">
            <img src='/images/CoverNovel.jpg' alt='#' width={"180px"}/>
            <div className='text-header'>
                ...
                <div className="Link-btn">
                    ...
                    <LinkButton variant='btn btn--outline' href="https://www.nihbuatjajan.com/rossi_ramadhan/e/65d4114fd76624005060efeb" con='btn--image-icon'>Full read on NihBuatJajan <img src="/images/external-link.png" width={"15px"}/>
                    </LinkButton>       
                </div>
            </div>      
        </div>
